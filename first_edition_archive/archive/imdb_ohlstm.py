...
if __name__ == '__main__':
    ...
    with tf.Graph().as_default():
        with tf.device('/gpu:0'):
            ...
            summary_writer = tf.train.SummaryWriter("imdb_ohlstm_logs/",
                                                graph=sess.graph)
            ...
            for epoch in range(training_epochs):
                ...
                for i in range(total_batch):
                    ...
                    if i % 100 == 0:
                        ...
                        for b in xrange(50):
                            _, _, _ = sess.run([acc_accum_incr, val_batches_incr, val_loss_incr], feed_dict={x: val_x[50*b:50*b+50], y: val_y[50*b:50*b+50], phase_train: False})
                        ...
                        _, _, _ = sess.run([acc_accum_clr, val_batches_clr, val_loss_clr])
